...
/*
 * The two colours the pencil has until there is a palette. 0xAARRGGBB, matching the
 * ARGB8888 the document is.
 *
...
bool tool_event (const SDL_Event *e, VNG_TAB *t)
{
	...
	case SDL_EVENT_MOUSE_BUTTON_DOWN: {
		...
		ink     = (button == SDL_BUTTON_RIGHT) ? ERASE : INK;
		drawing = true;
		last_x  = x;
		last_y  = y;

		vng_tab_put(t, x, y, ink);
		return true;
	}
